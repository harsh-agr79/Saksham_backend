...
use App\Http\Controllers\YTPlayListController;
use App\Http\Controllers\CodingChallengeController;
/*
|--------------------------------------------------------------------------
| API Routes
|--------------------------------------------------------------------------
...
Route::group(['middleware'=>'api_key'], function () { 
    ...
    Route::prefix('student')->group(function () {
        Route::middleware(['auth:student', 'verified'])->group(function () {
            ...
            Route::post('/contribute', [ContributionController::class, 'incrementContribution']);
            Route::get('/getcontribution', [ContributionController::class, 'getContributions']);

            Route::get('/getytplaylists', [YTPlayListController::class, 'getytplaylists']);
            Route::get('/getcodingchallenges', [CodingChallengeController::class, 'getValidChallenges']);
            Route::get('/getcodingchallenge/{id}', [CodingChallengeController::class, 'getChallenge']);
            Route::post('/submit-challenge', [CodingChallengeController::class, 'submitChallenge']);
        });
    });
